...
//   { endcase_str,        _endcase,         IMMEDIATE + COMP_ONLY },    // CAL
  { pw_str,             _pw,              NORMAL }, // seesaw peripheral's 'freq' word 08 Jan 2018 - semi-nonfictional at the moment.
...
//   { eeWrite_str,        _eeprom_write,    NORMAL },
  ...
  { npxBright_str,      _npxBright,       NORMAL }, // NORMAL

#endif // #ifdef NEO_PIXEL

  { clock_str,          _clock,           NORMAL }, // NORMAL
  // { tc4cc0_str,         _tc4cc0,       NORMAL }, // NORMAL
  { gendiv_str,         _gendiv,          NORMAL }, // NORMAL
  { period0_str,        _period0,         NORMAL }, // NORMAL
  { period1_str,        _period1,         NORMAL }, // NORMAL
  { timers_str,         _timers,          NORMAL }, // NORMAL
  { NULL,           NULL,    NORMAL }
};
